...
namespace Amazon.XRay.Recorder.Handlers.AwsSdk.Internal
{
    ...
    public class XRayPipelineHandler : PipelineHandler
    {
        ...
        public XRayPipelineHandler()
        {
            ...
            AWSServiceHandlerManifest  = InitWithDefaultAWSWhitelist();
        }
        ...
        public static AWSServiceHandlerManifest GetAWSServiceManifest(string path)
        {
            if (string.IsNullOrEmpty(path))
            {
                ...
                return InitWithDefaultAWSWhitelist();
            }
            else
            {
        ...
        private static AWSServiceHandlerManifest InitWithDefaultAWSWhitelist()
        {
        ...
        private static AWSServiceHandlerManifest Init(Stream stream)
        {
